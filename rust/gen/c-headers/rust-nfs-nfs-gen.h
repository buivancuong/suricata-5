...
int8_t rs_nfs_parse_request(Flow * flow, NFSState * state, void * _pstate, const uint8_t * input, uint32_t input_len, void * _data);
int8_t rs_nfs_parse_request_tcp_gap(NFSState * state, uint32_t input_len);
int8_t rs_nfs_parse_response(Flow * flow, NFSState * state, void * _pstate, const uint8_t * input, uint32_t input_len, void * _data);
int8_t rs_nfs_parse_response_tcp_gap(NFSState * state, uint32_t input_len);
int8_t rs_nfs_parse_request_udp(Flow * _flow, NFSState * state, void * _pstate, const uint8_t * input, uint32_t input_len, void * _data);
int8_t rs_nfs_parse_response_udp(Flow * _flow, NFSState * state, void * _pstate, const uint8_t * input, uint32_t input_len, void * _data);
...
int8_t rs_nfs_state_get_event_info_by_id(int event_id, const char ** event_name, AppLayerEventType * event_type);
...
int8_t rs_nfs_probe_ms(uint8_t direction, const uint8_t * input, uint32_t len, uint8_t * rdir);
